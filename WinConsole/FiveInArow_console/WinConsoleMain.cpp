...
void main()
{
	...
	//载入棋盘供调试用
	//LoadChessBoard_ASCI(ChessBoard,15,15,"D:\\StudyCreateLog\\programMake\\いま\\五子棋AI\\五子棋AI\\temp.txt");
	//PrintChessBoard(ChessBoard,15,15);
	...
	//LoadStep_ASCI(ChessBoard,&steplog,"D:\\StudyCreateLog\\programMake\\いま\\五子棋AI\\五子棋AI\\steplog_debug.txt");
	//PrintChessBoard(ChessBoard,15,15);
